# Nigerian Legacy RP Setup and Immigration
...
- `📋 ADMINISTRATION`: `#nigerian-legacy-logs`

It also creates any missing standard Nigerian Legacy roles, including `Immigration Officer` and `Citizen`.
...
apply for citizenship and use the economy. It also writes the join event to `#nigerian-legacy-logs`.
